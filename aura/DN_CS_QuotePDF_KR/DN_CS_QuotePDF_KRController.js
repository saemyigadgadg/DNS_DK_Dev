({
    init : function(component, event, helper) {
        ...
        keyCheck.setCallback(this, function(response){
            ...
            if(msg == 'SUCCESS'){
                ...
                component.set('v.url', '/apex/DN_CS_QuotePDF_KRPage?Id=' + component.get('v.recordId') + '&Language=KR');
                ...
                action.setCallback(this, function(response) {
                    ...
                    if(state === "SUCCESS") {
                        ...
                        console.error('Failed to load QuoteLineItems: ' + response.getError());
                    }
                });
                ...
                var toastEvent = $A.get("e.force:showToast");
                    toastEvent.setParams({
                        "title": "Error",
                        "message": JSON.stringify(msg) + ' 필드의 값을 입력해주세요.',
                        "type": "error"
                    });
                    toastEvent.fire();
    ...
    createPDF: function(component, event, helper) {
        var selectedLanguage = component.get("v.languageSelection");
        var recordId = component.get("v.recordId");
        var pdfPageUrl = "/apex/DN_CS_QuotePDF_" + selectedLanguage + "Page?Id=" + recordId;
        console.log("PDF Page URL: " + pdfPageUrl);
        window.open(pdfPageUrl, "_blank");

        // generatePDF매서드 바꿔야 됨
    ...
    handleLanguageChange : function(component, event, helper) {
        ...
        if (selectedLanguage === 'KR') {
            component.set('v.url', '/apex/DN_CS_QuotePDF_KRPage?Id=' + recordId + '&Language=KR');
        } else if (selectedLanguage === 'EN') {
            component.set('v.url', '/apex/DN_CS_QuotePDF_ENPage?Id=' + recordId + '&Language=EN');
        }
    },
})