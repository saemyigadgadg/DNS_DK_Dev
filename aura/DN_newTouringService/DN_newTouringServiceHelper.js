...
({
    ...
    //     console.log("[helper.closeModal] Modal container: ", modalContainer);
    
    //     if (modalContainer) {
    //         modalContainer.set("v.body", []); 
    //         console.log("[helper.closeModal] Modal closed successfully.");
    //     } else {
    //         console.error("[helper.closeModal] Modal container not found.");
    //     }
    // },
