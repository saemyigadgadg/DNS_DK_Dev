({
    init : function(component, event, helper) {
        ...
        keyCheck.setCallback(this, function(response){
            ...
            if(msg == 'SUCCESS'){
                // component.set('v.url', '/apex/DN_QuotationExport_ENPage?Id=' + component.get('v.recordId'));
                if(this.currentUrl.includes('site')){
                    //Portal이면
                    component.set('v.url', $A.get("$Label.c.PartnerPortal") + '/apex/DN_QuotationExport_ENPage?Id=' + component.get('v.recordId'));
                }else{
                    component.set('v.url', '/apex/DN_QuotationExport_ENPage?Id=' + component.get('v.recordId'));
                }
