...
({
    ...
    //설치검수 모달 열기
    openInstallationModalOpen: function (component, event, helper) {
    ...
    handleButtonClick : function(component, event, helper) {
        ...
        const jsonMessage = event.getParams('detail').receivedMessage;
        console.log('JSON From IFrame ::: ', JSON.stringify(jsonMessage, null, 2));
        if(isDesktop){
            component.set("v.isModalOpen", false); 
            helper.getUpdateScore(component, event, helper);
        }
    },
    ...
    doSave: function (component, event, helper) {
        try {
            ...
            saveWorkOrderResult.inspectionScore = parseFloat(component.get("v.serviceData").inspectionScore);
    ...
    handleCmpEvent: function (component, event, helper) {
        ...
        console.log('handleCompEvent ::: ', JSON.stringify(workList,null,2));
    },
