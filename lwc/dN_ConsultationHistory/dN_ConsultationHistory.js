...
import getActivityList from '@salesforce/apex/DN_TicketActivityListController.getActivityList';

export default class DN_ConsultationHistory extends LightningElement {
    @api recordId;
    @track sortBy;
