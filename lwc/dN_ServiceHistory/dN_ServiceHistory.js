...
import getServiceHistory from '@salesforce/apex/DN_ServiceHistoryController.getServiceHistory';

export default class DN_ServiceHistory extends LightningElement {
// export default class DN_ServiceHistory extends NavigationMixin(LightningElement){
    @api recordId;
    ...
    workOrderColumns = [
        ...
        {label : label.DNS_C_WorkCenter, fieldName : 'WorkCenter', type : 'text', sortable: true, initialWidth: 100},            
        {label : label.DNS_C_ServiceResource, fieldName : 'ServiceResource', type : 'text', sortable: true, initialWidth: 100}          
    ];
