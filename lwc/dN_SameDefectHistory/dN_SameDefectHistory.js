...
import getSameFailureHistory from '@salesforce/apex/DN_ServiceHistoryController.getSameFailureHistory';

export default class DN_SameDefectHistory extends LightningElement {
    @api recordId;
    ...
    ticketColumns = [
        ...
        // {label : label.DNS_C_ActionDetails, fieldName : 'InspectionDetails', type : 'text', sortable: true},           
        {label : label.DNS_C_ReceptionDetails, fieldName : 'ReceptionDetails', type : 'text', sortable: true},
    ];
    ...
    workOrderColumns = [
        ...
        //     typeAttributes: {label: {fieldName:'CaseNumber'}, target: '_blank'}},
        {label : label.DNS_C_OrderNumber, fieldName : 'OrderURL', type : 'url', sortable : true,
            typeAttributes: {label: {fieldName:'OrderNumber'}, target: '_blank'}},
        {label : label.DNS_C_OrderType, fieldName : 'OrderType', type : 'text', sortable: true},
        {label : label.DNS_C_OrderStatus, fieldName : 'OrderStatus', type : 'text', sortable: true},
        ...
        // {label : label.DNS_FDM_DispatchedDate, fieldName : 'ScheduledDispatchTime', type : 'date', sortable: true},      
